...
namespace Crest
{
    ...
    public class SimSettingsAnimatedWaves : SimSettingsBase, IReadbackSettingsProvider
    {
        ...
        [SerializeField, Tooltip("Cache CPU requests for ocean height. Requires restart. If collision source is Compute Shader Queries, we recommend turning off caching as it is unlikely to make an impact."), HideInInspector]
        bool _cachedHeightQueries = false;
        public bool CachedHeightQueries { get { return _cachedHeightQueries; } }

        [Header("GPU Readback Settings (DEPRECATED)")]
