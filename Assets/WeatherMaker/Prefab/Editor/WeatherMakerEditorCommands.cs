...
namespace DigitalRuby.WeatherMaker
{
    ...
    public static class WeatherMakerEditorCommands
    {
        ...
        private static void DeleteScriptableRenderPipeline()
        {
        ...
        {
            UnityEngine.Rendering.GraphicsSettings.renderPipelineAsset = null;
            DeleteScriptableRenderPipeline();
        ...
        public static void EnableLightweightPipeline()
        {
            ...
            {
                UnityEditor.EditorUtility.DisplayDialog("Error", "Please import LWRP package first, latest 6.X version is supported. If you just installed this, please restart Unity and try again.", "OK");
                return;
            }
